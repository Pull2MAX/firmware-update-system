...
uint8_t M24C02_ReadData(uint8_t addr, uint16_t read_length, uint8_t *read_arr); // The return value represents the error information, parameters need to manually input the starting address to read and the content to be stored
